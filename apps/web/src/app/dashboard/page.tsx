        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-5">
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-4 group cursor-pointer" onClick={() => router.push('/')}>
              <div className="w-12 h-12 bg-[#d4af37] rounded-xl flex items-center justify-center shadow-lg group-hover:scale-110 transition-transform duration-300 ring-4 ring-white/20">
                <span className="text-[#0f4c3a] font-bold text-xl">ꯂ</span>
              </div>
              <div>
                <h1 className="text-2xl font-bold tracking-tight">ꯂꯥꯏꯔꯤꯛ-ꯄꯨꯜꯁ</h1>
                <p className="text-xs text-[#d4af37] font-semibold uppercase tracking-widest">Lairik Pulse</p>
              </div>
            </div>
